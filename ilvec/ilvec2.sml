...
val I : int -> INT = E o E.I
val B : bool -> BOOL = E o E.B
...
val op +  : INT * INT -> INT = binop E.+
val op -  : INT * INT -> INT = binop E.-
val op *  : INT * INT -> INT = binop E.*
val op <  : INT * INT -> BOOL = binop E.<
val op <= : INT * INT -> BOOL = binop E.<=
val op == : INT * INT -> BOOL = binop E.==
val max   : INT -> INT -> INT = curry(binop(uncurry E.max))
val min   : INT -> INT -> INT = curry(binop(uncurry E.min))

local open Program infix >> ::= 
in
  type prog = Name.t -> p
